        ...
        <div className="App">
            <header className="App-header">
                ...
                <div className="offset">
                    ...
                    <div className="about-host container-2">
                        <div className="center align-center">
                            <div id="about">
                                ...
                                <div className="about-host-icons">
                    ...
                    <div className="about-discord flex-container">
                        <div className="about-discord-text container">
                            <div className="center">
                        ...
                        <div className="about-discord-icons container">
                            <div className="center">
                                <i className="font-awesome fab fa-discord"></i>
                            </div>
                        </div>
                    </div>
                    <div className="about-portfolio flex-container">
                        <div className="about-portfolio-icons container">
                            <div className="center">
                    ...
                    <div className="qna-div container-2">
                        <div className="center">
                            <div id="support">
